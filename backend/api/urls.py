...
urlpatterns = [
    ...
    path('user/delete/<str:username>/', company.CompanyUserDeleteView.as_view(), name='delete_company_user'),
    ...
    path('document/list/', documents.DocumentListView.as_view(), name='document_list'),
